...
<body>
    ...
    $stmt = $conn->prepare("SELECT * FROM photos WHERE photo_id =$id ");
   ...
   while ($row = $stmt->fetch()) {
    ...
    $dimen=$row['photo_Dimension'];
        $license=$row['photo_License'];
        echo  "
        <div class='container-fluid tm-container-content tm-mt-60'>
            <div class='row mb-4'>
            <h2 class='col-12 tm-text-primary'>$phototitle</h2>
            </div>
                ...
                <div class='col-xl-4 col-lg-5 col-md-6 col-sm-12'>
                    <div class='tm-bg-gray tm-video-details'>
                        ...
                        <div class='mb-4 d-flex flex-wrap'>
                            <div class='mr-4 mb-2'>
                                <span class='tm-text-gray-dark'>Dimension: </span><span class='tm-text-primary'> $dimen</span>
                            </div>
                            <div class='mr-4 mb-2'>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <!-- <h2 class="col-12 tm-text-primary">    $row['photo_title']    </h2> -->
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/$image" alt="Image" class="img-fluid">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div>
                        ...
                        <a href="#" class="tm-text-primary mr-4 mb-2 d-inline-block">phone</a>
