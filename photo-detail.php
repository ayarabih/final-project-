...
//  $stmt =  $conn->query("SELECT FROM photos WHERE photo_id= $id") ;
// $row = $stmt->fetch();
?>
<?php
...
<!-- //     <img src="<?php echo $row['photo_image']?>" alt="Image" class="img-fluid"> -->
//     <?php
// }
//  }
    ?>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">phone</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/Samsung-Galaxy-A34.png" alt="Image" class="img-fluid">
            </div>
