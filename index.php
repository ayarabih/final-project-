    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                <form action="photo-detail.php" class="tm-text-primary">
...
while ($row = $stmt->fetch()) {
    ...
    <figure class='effect-ming tm-video-item'>
        <img src='./img/$image' alt='$phototitle' class='img-fluid'>
        <figcaption class='d-flex align-items-center justify-content-center'>
            <h2>  $phototitle </h2>
            <a href= photo_detail.php?id=$photo_id ; >View more</a>
        </figcaption>                    
    </figure>
...
?>
        	...
        	<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="img/all-about-tabby-cats-552489-hero-a23a9118af8c477b914a0a1570d4f787.jpg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
...
<!--             
             <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="img/61LjIoy0hOL.__AC_SX300_SY300_QL70_ML2_.jpg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>headphone</h2>
            ...
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="javascript:void(0);" class="btn btn-primary tm-btn-prev mb-2 disabled">Previous</a>
                    <?php for($x =1; $x<=$pages; $x++):?>
                        <a href="?page=<?php echo $x; ?> $perpage=<?php echo $perpage; ?>" class="tm-paging-link"><?php echo $x?></a> 
                        <?php endfor;?>
            ...
            <div class="row">
                <div class="col">
                    <div class="btn btn-toolbar">
                        <div class="btn-group">
                            <a herf="#"><button class="btn-btn-primary">01</a>
                            <a herf="#"><button class="btn-btn-primary">02</a>
                            <a herf="#"><button class="btn-btn-primary">03</a>
