<?php
 ...
 $sql = "UPDATE  categories where categorie_name= $id";
				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="images/915881e9-c54b-4395-9473-b2e9d9e61de6.jfif" alt="..." class="img-circle profile_img">
						</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> Photos <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="addPhotop.php">Add Photo</a></li>
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
									<img src="images/915881e9-c54b-4395-9473-b2e9d9e61de6.jfif" alt="">maha ahmed
								</a>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="./welcome4.php" method="post">
