<?php
 include('./configr.php');  ;  
	...
	// $id = $_GET['id']; 
// $sql = "UPDATE  user where user_id= $id";
if(isset($_GET['id'])){
	$id = $_GET['id']; 
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="code.php" method="post">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"  for="first-name"  >Full Name <span class="required" >*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control" name="fullname" value="<?php?>">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="password" name="password">Password <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" class="btn btn-success" value="submit" name="send">update</button>
											</div>
										</div>
