					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="./welcome3.php" method="post">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="photo-date">Photo Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="photo-date" required="required" class="form-control " name="photodata">
											</div>
										</div>
										<div class="item form-group">
										...
										<label class="col-form-label col-md-3 col-sm-3 label-align" for="title">Tag <span class="required">*</span>
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="category" id="">
													...
													<option value="cat1">phone</option>
													<option value="cat2">laptop</option>
													<option value="cat2">headphone</option>
												</select>
											
											</div>
										</div>
										<!-- <div class="item form-group">
										<label class="col-form-label col-md-3 col-sm-3 label-align" for="title">Tag id <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
