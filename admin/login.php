...
if(isset($_POST['send'])){
  ...
  if(!empty($_POST['username']) && !empty($_POST['password'])) {
    $_SESSION['user_name']=$_POST['username'];       // نسجل البيانات في السيشن  بنعرف السيشن ونربطها بالبوست         
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form >
              ...
              <div>
                <a class="btn btn-default submit" href="../index.php" name="send">Log in</a>
